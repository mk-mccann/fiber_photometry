...
def plot_color_code_episodes(data_df, f_trace='zscore_Lerner', channel_key=None):
    ...
    fp.plot_fluorescence_min_sec(data_df.time.to_numpy(), f_trace, ax=ax1)
    ...
    fp.plot_fluorescence_min_sec(data_df.time.to_numpy(), f_trace, ax=ax2)
...
if __name__ == "__main__":
    ...
    try:
        ...
        fig = plot_color_code_episodes(data)
